...
import com.wangshuo.videostrategy.videostrategy.strategy.filter.tools.GLESTools;
...
public class VideoGroupFilter extends BaseVideoFilter {
    ...
    private class FilterWrapper {
        ...
        FilterWrapper(BaseVideoFilter filter) {
            this.filter = filter;
        }
    }
}
