package com.wangshuo.videostrategy.videostrategy.strategy.encoder;
...
import com.wangshuo.videostrategy.videostrategy.strategy.encoder.utils.RenderHandler;
...
public class MediaVideoEncoder extends MediaEncoder {
    ...
    public MediaVideoEncoder(final MediaMuxerWrapper muxer, final MediaEncoderListener listener, final int width, final int height, int recFps) {
    ...
    private int calcBitRate() {
        ...
        return /*(bitrate + 600*1024)*/ 3 * 1000 * 1000;
    }
